...
from mmf.datasets.builders.objectification.dataset import (
    objectificationFeaturesDataset,
    objectificationImageDataset,
)
...
@registry.register_builder("objectification")
class objectificationBuilder(MMFDatasetBuilder):
    def __init__(
        self,
        dataset_name="objectification",
        dataset_class=objectificationImageDataset,
        *args,
        **kwargs
    ):
        super().__init__(dataset_name, dataset_class, *args, **kwargs)
        self.dataset_class = objectificationImageDataset

    @classmethod
    def config_path(self):
        return "configs/datasets/objectification/defaults.yaml"

    def load(self, config, dataset_type, *args, **kwargs):
        config = config
        
        if config.use_features:
            self.dataset_class = objectificationFeaturesDataset
