...
from mmf.datasets.builders.misogynous.dataset import (
    misogynousFeaturesDataset,
    misogynousImageDataset,
)
...
@registry.register_builder("misogynous")
class misogynousBuilder(MMFDatasetBuilder):
    def __init__(
        self,
        dataset_name="misogynous",
        dataset_class=misogynousImageDataset,
        *args,
        **kwargs
    ):
        super().__init__(dataset_name, dataset_class, *args, **kwargs)
        self.dataset_class = misogynousImageDataset

    @classmethod
    def config_path(self):
        return "configs/datasets/misogynous/defaults.yaml"

    def load(self, config, dataset_type, *args, **kwargs):
        config = config
        
        if config.use_features:
            self.dataset_class = misogynousFeaturesDataset
