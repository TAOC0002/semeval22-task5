...
class violenceFeaturesDataset(MMFDataset):
    def __init__(self, config, *args, dataset_name="violence", **kwargs):
...
class violenceImageDataset(MMFDataset):
    def __init__(self, config, *args, dataset_name="violence", **kwargs):
        super().__init__(dataset_name, config, *args, **kwargs)
        assert (
            self._use_images
